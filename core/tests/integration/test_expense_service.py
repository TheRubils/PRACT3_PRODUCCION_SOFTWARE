...
def test_remove_expense_reduces_total():
    ...
    service.create_expense(title="Libro", amount=5)
    service.create_expense(title="Revista", amount=10)
    service.remove_expense(1)
...
def test_total_amount_after_removal():
    ...
    service.create_expense(title="Curso", amount=30)
    service.create_expense(title="Internet", amount=25)

    total_n1 = service.total_amount()

    service.remove_expense(1)
    total_n2 = service.total_amount()
